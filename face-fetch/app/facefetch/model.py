...
wp = os.path.join(dirname, "Weights/nn4.small2.v1.h5")
def create_model(weights_path = wp, include_top = None, call = None):
    ...
    if include_top:
            ...
            print("/n")
            print("Weights Loaded with Include_top = True and Call = None !")
            print("/n")
            print("Adding Flatten and Dense Layer")
            print("/n")
            model.add(Flatten())
            ...
            model.load_weights(weights_path)
            print("/n")
            print("Weights Loaded with Include_top = False and Call = 0 !")
            return model
            ...
            model.load_weights(weights_path)
            print("\n")
            print("Weights Loaded with Include_top = False and Call = 1 !")
            print("\n")
            model1 = Model(inputs=model.layers[0].input, outputs=model.layers[-3].output)
            model2 = Model(inputs=model.layers[-2].input, outputs=model.layers[-1].output)
